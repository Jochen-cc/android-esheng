package com.qcyg.jochen.esheng.widget.autocomp;

import com.qcyg.jochen.esheng.R;
import com.qcyg.jochen.esheng.widget.autocomp.internal.entity.AccountType;
import com.qcyg.jochen.esheng.widget.autocomp.internal.model.CandidateCollector;
...
public class AccountAutoCompleteEditText extends AutoCompleteTextView {
	...
	private void setUpAttributes(Context context, AttributeSet attrs,
		...
		try {
			array = context.obtainStyledAttributes(attrs,
					R.styleable.AccountAutoCompleteEditText, defStyle, 0);
	...
	protected void onFinishInflate() {
		...
		ArrayAdapter<String> adapter = new ArrayAdapter<String>(getContext(),
				...
				CandidateCollector.getAccounts(getContext(), mAccountType));
